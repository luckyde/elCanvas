function el_animation(el, params){
  ...
  // var spinLine2 = el.line({x1:0,y1:0,x2:33,y2:33,opacity:1, rotation:0,style:{}})
  // var rect = el.rect({x:500,y:50,zIndex:4,scaleX:1,radius:20,opacity:0.6,style:{fillStyle:"black"}})
  // var circ = el.circle({opacity:0.5,parent:rect,style:{fillStyle:"red"}})
  // var circ2 = el.circle({x:30,opacity:0.9,parent:circ,style:{fillStyle:"blue"}})
